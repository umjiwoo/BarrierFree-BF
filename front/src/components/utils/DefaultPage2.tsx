  ...
  return (
    <View style={styles.container}>
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={[styles.button, { backgroundColor: '#1C2C58' }]} onPress={onUpperLeftTextPress}>
        ...
        <TouchableOpacity style={[styles.button, { backgroundColor: '#3A3A3C' }]} onPress={onUpperRightTextPress}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity style={[styles.button, { backgroundColor: '#34C759' }]} onPress={onLowerRightTextPress}>
